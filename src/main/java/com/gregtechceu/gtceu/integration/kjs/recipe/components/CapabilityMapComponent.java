...
public record CapabilityMapComponent() implements RecipeComponent<CapabilityMap> {
    ...
    public RecipeComponentType<?> type() {
        return RecipeComponentType.unit(GTCEu.id("capability_map"), CapabilityMapComponent.INSTANCE);
    }
    ...
    @Override
    public CapabilityMap replace(RecipeScriptContext cx, CapabilityMap original, ReplacementMatchInfo match,
                                 Object with) {
